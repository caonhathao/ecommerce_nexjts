...
export const Loading = () => {
  return (
    <div className="w-full h-full flex justify-center items-center bg-muted-foreground opacity-75">
      <Image
...
export const LoadingComponent = () => {
  return (
    <div className="w-full h-full flex justify-center items-center bg-background-secondary opacity-75">
      <Image
        src="/loading.gif" // <-- The path is from the root
        alt="Loading..."
        width={100} // <-- Set the actual width of your GIF
