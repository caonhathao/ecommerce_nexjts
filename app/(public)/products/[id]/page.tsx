...
const detaiPage = () => {
  ...
  return (
    <div className="w-[80%] flex flex-col justify-center items-center gap-2 mt-5">
      <section className="w-full flex flex-row justify-start items-start gap-2">
        {/* product's image */}
        <div className="w-[30%] bg-[var(--background)] rounded-lg flex flex-col p-2 sticky top-3">
          {/* slider */}
        ...
        <div className="w-[40%] flex flex-col gap-4">
              ...
              <div className="flex flex-row flex-wrap justify-start items-start gap-2">
                {data.variants.map((value, index) => (
                  <div
                    ...
                    onClick={() =>
                      handleSelectVariant(value.id, value.name, value.price, 1)
                    }
                  >
                    {value.name}
                  </div>
          ...
          <div className="bg-[var(--background)] p-3 rounded-lg flex flex-col justify-start items-start gap-1">
            ...
            <Separator />
            <div className="flex flex-row justify-start items-center gap-1">
              <PiTruckLight color="var(--chart-2)" size={15} /> Freeship 10k đơn
          ...
          {/* top deals */}
          <TopDealItems data={dTopDeal} size="1/4" renderSaleValue={false} />
          {/* slo-gan */}
        ...
        {/* payment methods */}
        <div className="w-[30%] bg-[var(--background)] rounded-lg p-3 flex flex-col gap-3 sticky top-3">
          {/* title */}
          <div className="flex flex-row justify-start items-center gap-2">
            <p>2T3H</p>
